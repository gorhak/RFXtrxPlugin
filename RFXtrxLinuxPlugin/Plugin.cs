...
namespace SwitchKing.Server.Plugins.RFXtrx
{
        ...
        IDisposable
    {
        ...
        public static Queue<string> recieveQueue = new Queue<string>();
        ...
        {
            TraceIt("SendRestCommand " + url.ToString(), true);
            {
        ...
        //private static void OnCommandToFile(int deviceId, string deviceName, int deviceActionId, string oldAction, int? dimLevel, string eventSource, bool WriteToFile)
        //{
        //    if (WriteToFile)
        //    {
        //        Trace.Indent();
        //        TraceIt("deviceId: " + deviceId.ToString(), WriteToFile);
        //        TraceIt("deviceName: " + deviceName.ToString(), WriteToFile);
        //        TraceIt("deviceActionId: " + deviceActionId.ToString(), WriteToFile);
        //        TraceIt("deviceActionName: " + oldAction.ToString(), WriteToFile);
        //        if (dimLevel != null)
        //            TraceIt("dimLevel: " + dimLevel.ToString(), WriteToFile);
        //        else
        //            TraceIt("dimLevel: " + "NULL", WriteToFile);
        //        TraceIt("eventSource: " + eventSource.ToString(), WriteToFile);
        //        Trace.Unindent();
        //    }
        //}
        ...
        public void OnLoop()
        {
            ...
            if (0 < recieveQueue.Count)
            {
                lock (recieveQueue)
                {
                    EventRecieved(recieveQueue.Dequeue());
                }
            }
            //while (0 < recieveQueue.Count)
            //{
            //    lock (recieveQueue)
            //    {
            //        EventRecieved(recieveQueue.Dequeue());
